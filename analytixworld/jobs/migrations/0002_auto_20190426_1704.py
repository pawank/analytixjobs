    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=500, null=True, verbose_name='Company name')),
                ('no_employees', models.IntegerField(blank=True, null=True, verbose_name='No of Employees')),
                ('website', models.URLField(blank=True, null=True, verbose_name='Website')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('address', models.TextField(null=True, verbose_name='Description')),
                ('primary_phone_no', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None)),
                ('alt_phone_no', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None)),
                ('fax_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None)),
            ],
            options={
                'ordering': ('name', 'primary_phone_no'),
            },
        ),
        migrations.AddField(
            model_name='job',
        ...
        migrations.AddField(
            model_name='job',
            name='ending_salary',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=4, default=None, default_currency='USD', max_digits=19, null=True),
        ),
        migrations.AddField(
            model_name='job',
            name='ending_salary_currency',
        ...
        migrations.AddField(
            model_name='job',
            name='gender',
            field=models.CharField(blank=True, choices=[('any', 'Any'), ('male', 'Male'), ('female', 'Female'), ('other', 'Other')], default='any', max_length=255, null=True, verbose_name='Gender'),
        ),
        migrations.AddField(
            model_name='job',
            name='industry',
            field=models.CharField(max_length=500, null=True, verbose_name='Industry'),
        ),
        migrations.AddField(
            model_name='job',
            name='job_type',
            field=models.CharField(choices=[('full-time', 'Fulltime'), ('freelance', 'Freelance'), ('internship', 'Internship'), ('part-time', 'Parttime'), ('contract', 'Contract')], default='full-time', max_length=255, null=True, verbose_name='Job Type'),
        ),
        migrations.AddField(
            model_name='job',
            name='location',
        ...
        migrations.AddField(
            model_name='job',
            name='skills',
            field=models.TextField(blank=True, null=True, verbose_name='Job Skills'),
        ),
        migrations.AddField(
            model_name='job',
            name='source',
            field=models.CharField(max_length=255, null=True, verbose_name='Job Source'),
        ),
        migrations.AddField(
            model_name='job',
